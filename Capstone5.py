...
st.set_page_config(page_title='HDB Flat Resale Price Predictor',page_icon='house',initial_sidebar_state='expanded',
                        layout='wide',menu_items={"about":'This streamlit application was developed by Naveen Moorthy'})
...
with _:
    st.empty()
    st.image('/Users/naveenmoorthy/Desktop/Code/Singapore Animated Logo.gif')
    st.empty()
    ...
    if button:
        with st.spinner("Predicting..."):
            ...
            if not all([user_month,user_town,user_flat_type,user_flat_model,floor_area_sqm,price_per_sqm,year,block,
                ...
                with open('/Users/naveenmoorthy/Desktop/Code/Decisiontree.pkl','rb') as files:
...
if selected == "Home":
    ...
    with c1:
        st.image('/Users/naveenmoorthy/Desktop/Code/Bishan_HDB.jpeg',use_column_width=True)
    with c2:
        st.image('/Users/naveenmoorthy/Desktop/Code/JurongwestHDB.JPG',use_column_width=True)
    with c3:
        st.image('/Users/naveenmoorthy/Desktop/Code/Singapore-HDB.jpg')
    with c4:
        st.image('/Users/naveenmoorthy/Desktop/Code/What-kind-of-properties-can-a-Permanent-Resident-PR-buy-in-Singapore.jpg',
                use_column_width=True)

    st.link_button(label='Official Website',url='https://www.hdb.gov.sg/cs/infoweb/homepage',use_container_width=True)

    st.subheader(':orange[**Check this Video Out :**]')
    col1,col2=st.columns(2)
    with col1:
...
if selected == "About":
    ...
    st.markdown('''**Hello All,  
                I am Naveen Moorthy. with a keen interest in data science and analytics. Currently on an exciting journey into the world of data science...**''')
    st.link_button('Linkedin','https://www.linkedin.com/in/naveen-moorthy-0b66531a5/') 